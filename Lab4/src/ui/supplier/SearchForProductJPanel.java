...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    try {
        int productId = Integer.parseInt(productIdText); // Assuming product IDs are integers
        ...
        if (foundProduct != null) {
            // If product is found, display its details (assuming ProductDetailsJPanel exists)
            ViewProductDetailJPanel productDetailsPanel = new ViewProductDetailJPanel(workArea, foundProduct);
        ...
        JOptionPane.showMessageDialog(this, "Invalid product ID. Please enter a valid number.");
    }
